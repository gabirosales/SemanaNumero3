...
public class ConvertirTipoDato {
    public static void main(String[] args) {
        ...
        System.out.println("Valor double a String " + polimorfismo.convertirAString((int) 10.0));
        System.out.println("Valor float a String " + polimorfismo.convertirAString((int) 10.12));
    }
